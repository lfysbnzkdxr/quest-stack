...
import com.queststack.ui.component.modifier.inspectDragGestures
...
/**
 * 阻尼拖动动画状态机（参考 KernelSU DampedDragAnimation）：
 * 管理指示器位置 value / 按压进度 pressProgress / 各向异性缩放 scaleX、scaleY / 速度 velocity，
 * 五个 Animatable 并行弹簧驱动，MutatorMutex 保证动画互斥。
 */
